...
import MakeSellerModal from '../../DashBoardModal/MakeSellerModal';

const RequestedSellerTable = ({user,setUsers}) => {
    ...
    return (
        ...
        <MakeSellerModal isOpen={isOpen} setIsOpen={setIsOpen} setUsers={setUsers} id={_id} userEmail={userEmail}/>
      </tr>
    );
};
