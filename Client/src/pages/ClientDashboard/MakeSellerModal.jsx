...
import { requestSeller } from "../../api/user/user";

const MakeSellerModal = ({ isOpen, setIsOpen }) => {
  ...
  const requestForSeller = () => {
    requestSeller(userEmail).then((data) => console.log(data));
    toast.success("Request Sent for Seller Check Your Dashboard Accordingly");
    closeModal();
  };
